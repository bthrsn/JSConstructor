...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var column = this.value.map(_utils.col).join('');
      return (0, _utils.row)(column, (0, _utils.css)(this.options.styles));
    }
  }]);
...
}), new _blocks.ImageBlock(_imageAchievment.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
...
}), new _blocks.ColumnsBlock(['Без использования библиотек', 'Принципы SOLID и ООП в JavaScript', 'UI своими руками'], {
  styles: {
